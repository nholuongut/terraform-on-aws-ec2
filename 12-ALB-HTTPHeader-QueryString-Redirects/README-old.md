...
- **Rule-3:** When Query-String, website=aws-eks redirect to https://nholuongut.com/aws-eks/ 
- **Rule-4:** When Host Header = azure-aks.nholuongut.com, redirect to https://nholuongut.
...
- Rule-4: When Host Header = azure-aks.nholuongut.com
```t
  # Rule-4: When Host Header = azure-aks.nholuongut.com
    { 
      https_listener_index = 0
      ...
      conditions = [{
        host_headers = ["azure-aks11.nholuongut.com"]
      }]
    },   
```
...
resource "aws_route53_record" "app1_dns" {
  zone_id = data.aws_route53_zone.mydomain.zone_id 
  name    = "azure-aks11.nholuongut.com"
  type    = "A"
  alias {
    name                   = module.alb.this_lb_dns_name
    zone_id                = module.alb.this_lb_zone_id
...
- [ALB Outpus Reference](https://github.com/nholuongut/terraform-aws-alb/blob/v6.0.0/examples/complete-alb/outputs.tf)
...
- When Query-String, website=aws-eks redirect to https://nholuongut.com/aws-eks/
```t
# Verify Rule-3
https://myapps.nholuongut.com/?website=aws-eks 
Observation: 
1. Should Redirect to https://nholuongut.com/aws-eks/
```

## Step-08: Verify Rule-4
-  When Host Header = azure-aks.nholuongut.com
```t
# Verify Rule-4
http://azure-aks.nholuongut.com
Observation: 
