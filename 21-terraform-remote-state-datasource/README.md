...
# Add DNS name relevant to demo
  name    = "tf-multi-app-projects.nholuongut.com"
```
...
```t
# Access Application
https://tf-multi-app-projects1.nholuongut.com
https://tf-multi-app-projects1.nholuongut.com/app1/index.html
https://tf-multi-app-projects1.nholuongut.com/app1/metadata.html
```
